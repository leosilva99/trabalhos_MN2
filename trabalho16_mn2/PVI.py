class PVI:
    ...
    def pontos_criticos1(self):
        ...
        while(y_atual > 0): # testar se a altura já é suficientemente perto de 0m(nível do mar)
            v_atual, y_atual = self.sol_aprox1(v_ant, y_ant)
    ...
    def sol_aprox1(self, v_antigo, y_antigo):
        v_atual = v_antigo + self.delta_t*(-self.g - ((self.k/self.m)*v_antigo)) # velocidade do passo i
        y_atual = y_antigo + self.delta_t*v_antigo # altura no passo i
